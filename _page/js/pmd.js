...
首页</s-chip>
<s-chip id="side_ship_1" onclick="openURL('//mc.kdxiaoyi.top/Streack/#play',true)" clickable="true" class="sidebar_btn">
...
加入我们</s-chip>
<s-chip id="side_ship_2" onclick="openURL('//mc.kdxiaoyi.top/Streack/doc/',true)" style="width:49%;margin:1% auto 1% 0%;" clickable="true" class="sidebar_btn">
...
文档目录</s-chip>
<s-chip id="side_ship_5" onclick="openURL('//mc.kdxiaoyi.top/Streack/#issue',true)" style="width:49%;margin:1% 0 1% 0%;" clickable="true" class="sidebar_btn">
...
反馈与申诉</s-chip>
<s-chip id="side_ship_4" onclick="openURL('//mc.kdxiaoyi.top/Streack/doc/event/',true)" style="width:49%;margin:1% auto 1% 0%;" clickable="true" class="sidebar_btn">
...
活动一览</s-chip>
<s-chip id="side_ship_3" onclick="openURL('//mc.kdxiaoyi.top/Streack/doc/news/',true)" style="width:49%;margin:1% 0 1% 0%;" clickable="true" class="sidebar_btn">
...
近期资讯</s-chip>
<s-chip id="side_ship_6" onclick="openURL('//mc.kdxiaoyi.top/Streack/webtool/status_next',true)" clickable="true" class="sidebar_btn">
...
服务器实时状态</s-chip>`,
  ...
  hyper_markdown: {
    ...
    header_link: true,
    /*在页面底端增加文章脚注，为空不额外添加*/
    footer: `Copyright © 2025, Streack & kdxiaoyi. All Right Reserved.<br><a href="https://mc.kdxiaoyi.top/Streack/policy/user" target="_blank">用户协议</a> | <a href="https://mc.kdxiaoyi.top/Streack/policy/privacy" target="_blank">隐私政策</a> | <a href="mailto:streack@kdxiaoyi.top" target="_blank">电子邮箱</a> | <a href="https://github.com/StreackMC" target="_blank">Github</a> | <a href="https://mc.kdxiaoyi.top/Streack/assets/license">版权许可</a><br>此站点与Mojang Studio、Microsoft或网易Netease没有任何关联。`,
    /*检查引用部分高级语法，详见文档*/
